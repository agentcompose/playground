...
// The roster of workers the master (engine) can delegate to. Read-only — it makes the
// registry visible so it's clear what the planner is choosing between, and what each
// agent is good for. The `search` note reflects how the research worker is wired.
